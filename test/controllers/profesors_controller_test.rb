...
class ProfesorsControllerTest < ActionController::TestCase
  ...
  test "should create profesor" do
    assert_difference('Profesor.count') do
      post :create, profesor: { apellido: @profesor.apellido, nombre: @profesor.nombre, nomina: @profesor.nomina, password: @profesor.password }
    end
  ...
  test "should update profesor" do
    patch :update, id: @profesor, profesor: { apellido: @profesor.apellido, nombre: @profesor.nombre, nomina: @profesor.nomina, password: @profesor.password }
    assert_redirected_to profesor_path(assigns(:profesor))
  end
