...
class ActividadsControllerTest < ActionController::TestCase
  ...
  test "should create actividad" do
    assert_difference('Actividad.count') do
      post :create, actividad: { descripcion: @actividad.descripcion, nombre: @actividad.nombre, ponderacion: @actividad.ponderacion }
    end
  ...
  test "should update actividad" do
    patch :update, id: @actividad, actividad: { descripcion: @actividad.descripcion, nombre: @actividad.nombre, ponderacion: @actividad.ponderacion }
    assert_redirected_to actividad_path(assigns(:actividad))
  end
