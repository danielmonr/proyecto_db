...
class DirectorsControllerTest < ActionController::TestCase
  ...
  test "should create director" do
    assert_difference('Director.count') do
      post :create, director: { nombre: @director.nombre, nomina: @director.nomina, password: @director.password }
    end
  ...
  test "should update director" do
    patch :update, id: @director, director: { nombre: @director.nombre, nomina: @director.nomina, password: @director.password }
    assert_redirected_to director_path(assigns(:director))
  end
